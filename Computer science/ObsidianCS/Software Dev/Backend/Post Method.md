...
The Post method is the method used in the [[HTTP]] to send information to the [[Server]] to storage that information in the [[DataBase]], this method is different to the [[Get Method]] because we don't send the information in the [[URL]] contrary we send the information in the **Body**
