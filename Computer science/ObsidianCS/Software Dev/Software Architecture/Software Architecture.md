...
The [[Software Architecture]] define the [[Server]], technologies, [[DataBase]] and the other things that we use in the [[Backend]] and [[Frontend]]. Another advantage of create a good [[Software Architecture]] is that we need to [[Software Dev/Software Architecture/Scalability]] our projects, that means we need to think constantly how to improve our service and how to grow the app using new technologies
